    ...
    <div>
        <div id="loadContract" class="d-flex justify-content-center align-items-center">
            <div class="text-center" style="width:60%">
                ...
                <hr>
                <input id="address" v-model="address" type="text" placeholder="Existing contract.."
                    class="mr-3 mt-4" /><button type="button" class="btn btn-primary"
                    @click="loadContract">Load</button>
            </div>
        </div>
