        ...
        <div class="mx-2 my-2 row" deck>
            ...
            <div class="col-7">
                <b-card body-class="text-center" class="mx-2 my-2" header-bg-variant="warning"
                    ...
                    <b-tabs card active-nav-item-class="font-weight-bold text-uppercase text-dark"
                        nav-class="font-weight-bold">
                        <!------------------- 관리자 ----------------->
                        <b-tab title="관리자">
                            <b-card-title>컨트렉트 관리자를 설정합니다.</b-card-title>

                            <b-form-group v-slot="{ selectedManager }">
                                <b-form-radio-group v-model="sel_man" :options="opt_man"
                                    :aria-describedby="selectedManager" stacked>
                                </b-form-radio-group>
                            </b-form-group>

                            <div class="mt-3">Selected: <strong>{{ sel_man }}</strong></div>

                            <b-form-tags input-id="tags-basic" v-model="val_man"></b-form-tags>
                        ...
                        <!------------------- 발행량 ----------------->
                        <b-tab title="발행량">
                            <b-card-title>NFT 발행량을 설정합니다.</b-card-title>

                            <b-form-group v-slot="{ selectedLimit }">
                                <b-form-radio-group v-model="sel_lim" :options="opt_lim"
                                    :aria-describedby="selectedLimit" stacked>
                                </b-form-radio-group>
                            </b-form-group>

                            <!-- 추후 삭제 -->
                            <div class="mt-3">Selected: <strong>{{ sel_lim }}</strong></div>

                            <b-input-group v-show='sel_lim == "first"' prepend="수량">
                                <b-form-input type="number" min="0" v-model="val_lim" placeholder="Enter your name">
                                </b-form-input>
                            </b-input-group>
                        ...
                        <!-- -------------------발행주기 ------------->
                        <b-tab title="발행 주기">
                            <b-card-title>NFT 발행 주기를 설정합니다.</b-card-title>

                            <b-form-group v-slot="{ selectedPeriod }">
                                <b-form-radio-group v-model="sel_per" :options="opt_per"
                                    :aria-describedby="selectedPeriod" stacked>
                                </b-form-radio-group>
                            </b-form-group>

                            <!-- 추후 삭제 -->
                            <div class="mt-3">Selected: <strong>{{ sel_per }}</strong></div>

                            <b-input-group v-show='sel_per == "first"' prepend="기간(일)">
                                <b-form-input type="number" min="0" v-model="val_per" placeholder="Enter your name">
                                </b-form-input>
                            </b-input-group>
                        ...
                        <b-tab title="발행 권한">
                            <b-card-title>NFT 발행 권한을 설정합니다.</b-card-title>

                            <b-form-group v-slot="{ selectedAuthenticationt }">
                                <b-form-radio-group v-model="sel_aut" :options="opt_aut"
                                    :aria-describedby="selectedAuthenticationt" stacked>
                                </b-form-radio-group>
                            </b-form-group>


                            <div class="mt-3">Selected: <strong>{{ sel_aut }}</strong></div>
                        ...
                        <!------------------- 여기다가 선택값 ----------------->
                        <b-tab title="준비 중...">
                            <b-card-title>업데이트를 기다려주세요!</b-card-title>
                ...
                <b-card class="mx-2 my-2" header-bg-variant="warning" header-text-variant="dark">
                    ...
                    <b-button variant="warning" class="mx-1 my-1 " @click="contract_Owner()">기본
                    </b-button>
        ...
        methods: {
            ...
            funMan() {
                ...
                if (this.sel_man == "first") {
                    ...
                    // require
                    this.tex_man3 = "        require(owner[msg.sender] = true);\r\n"
            ...
            funLim() {
                ...
                if (this.sel_lim == "first") {
                    this.tex_lim = "        require(NFTId < " + this.val_lim + ");\r\n"
